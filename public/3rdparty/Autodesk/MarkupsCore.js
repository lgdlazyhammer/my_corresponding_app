(function(){ 'use strict';
    ...
    namespace.createUUID = function() {
        // Create a client side UUID and append it to SVG element for LBS
...
(function(){ 'use strict';
     ...
     * @param {String} targetId - The id of the markup being affected.
     */
...
(function(){ 'use strict';
    ...
    proto.execute = function(action) {
        ...
        var targetId = action.selectOnExecution ? action.targetId : "";
        this.fireEvent(
    ...
    proto.cancelActionGroup = function() {
        ...
        this.fireEvent(
            {type: namespace.EVENT_HISTORY_CHANGED, data: {action: 'cancel', targetId: ""}});
    };
    ...
    proto.clear = function() {
        ...
        this.fireEvent(
            {type: namespace.EVENT_HISTORY_CHANGED, data: {action:'clear', targetId: ""}});
    };
...
(function(){ 'use strict';
     ...
     * @memberof Autodesk.Viewing.Extensions.Markups.Core
     *
     * @param {String} id - Identifier, populated with return value of {@link Autodesk.Viewing.Extensions.Markups.Core.MarkupsCore#getId getId()}.
...
(function(){ 'use strict';
    ...
    Autodesk.Viewing.Extensions.Markups.Core.MarkupsCore.prototype.getId = function() {
        ...
        // return ++this.nextId;
        return namespaceUtils.createUUID();
    };
    ...
    proto.onEditActionHistoryChanged = function(event) {
        ...
        if((data.action !== 'undo' && data.targetId) ||
